...
{
    /// <inheritdoc />
    public partial class ApplicationContextAndModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenerationAmount = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
                    TransmissionAmount = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
                    DistributionAmount = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
                    GovernmentTaxAmount = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CostEstimations_EnergyTariffs_EnergyTariffId",
                        column: x => x.EnergyTariffId,
                        principalTable: "EnergyTariffs",
                        principalColumn: "Id");
                });
